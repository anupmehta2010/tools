...
CATEGORIES: dict[str, tuple[str, str, str]] = {
    ...
    "completions": ("completions_tools", "Shell completions: bash, zsh, pwsh, fish", "📜"),
    "watch":       ("watch_tools",      "Folder watcher: trigger a tool on new/changed files",     "👁️"),
    "recipes":     ("recipes_tools",    "Recipes: save and run multi-step JSON pipelines",         "🧬"),
    "bundle":      ("bundle_tools",     "Bundle: build single-file .pyz / zip / native binary",    "📦"),
}
